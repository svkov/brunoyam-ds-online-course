...
Прежде чем мы начнем векторизацию текста и решать задачу классификации, давайте немного посмотрим на данные и проведем простую предобработку.
