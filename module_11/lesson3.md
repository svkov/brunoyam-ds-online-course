...
![Forest1.png](../images/forest_fitting.png)
...
Результат тот же, но работает быстрее. Чтобы измерить скорость выполнения, можно в первой строке ячейки написать `%%time`.
